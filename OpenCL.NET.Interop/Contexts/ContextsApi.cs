...
namespace OpenCL.NET.Interop
{
    ...
    using static Common;
    using static OpenCL.NET.Interop.Devices;
    ...
    public static partial class Contexts
    {
        ...
        /// <see cref="errorCode"/>.
        /// </returns>
        [DllImport(OPENCL_DLL_NAME, EntryPoint = "clCreateContext")]
        ...
        [DllImport(OPENCL_DLL_NAME, EntryPoint = "clCreateContextFromType")]
        ...
        /// </returns>
        [DllImport(OPENCL_DLL_NAME, EntryPoint = "clReleaseContext")]
        public static extern NativeCLResult ReleaseContext(
            [In] IntPtr context
        );
        ...
        /// <c>Result.OutOfHostMemory</c> if there is a failure to allocate resources required by the OpenCL implementation on the host.
        /// </returns>
        [DllImport(OPENCL_DLL_NAME, EntryPoint = "clGetContextInfo")]
        public static extern NativeCLResult GetContextInformation(
            [In] IntPtr context,
